...
function doesWordExist(yes, wordToSearch) {
  //let newst = [];
  if(!yes.length){
    return null;
   }
//for(let i = 0; i < yes.length; i++){
  //if(newst.indexOf(yes[i]) == -1) {
    //newst.push(yes[i])
  //}
//}
if(yes.indexOf(wordToSearch) == -1){
  return false
}
return true
  }
